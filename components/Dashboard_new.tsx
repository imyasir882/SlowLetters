        ...
        <div className="max-w-7xl mx-auto px-4 py-3">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-xl font-bold text-vintage-sepia font-serif">SlowLetters</h1>
                <p className="text-xs text-vintage-faded">Welcome back, {user.displayName}</p>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-2">
              ...
              <button
                onClick={onLogout}
                className="flex items-center space-x-2 px-3 py-2 text-vintage-faded hover:text-vintage-sepia hover:bg-vintage-cream/50 rounded-lg transition-all text-sm"
              >
        ...
        {!pairInfo?.pair ? (
          ...
          <div className="space-y-6">
            ...
            <motion.div
              initial={{ opacity: 0, y: -20 }}
              animate={{ opacity: 1, y: 0 }}
              className="bg-vintage-paper/50 rounded-xl p-4 border border-vintage-gold/20"
            >
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-3">
                  <div className="p-2 bg-vintage-gold/10 rounded-full">
                ...
                <div className="flex items-center space-x-4 text-xs text-vintage-faded">
